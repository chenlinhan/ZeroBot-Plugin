...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/genshin"        // 原神抽
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "Alice", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "ALICE", "alice"),
